...
<body onLoad="scrollStart();">	 
	...
	<div class="scrollWrapper" onMouseover="scrollspeed=0" onMouseout="scrollspeed=current">  
	  ...
	  <div id="scroll" >
	   ...
	   <div class="content">Contenido de ejemplo para el scroll de noticias personalizable. <a target="_top">La Web del programador</a>
	   </div>
	   
	  <div class="title">Segunda Noticia</div>
	  <div class="content">Contenido de ejemplo para el scroll de noticias personalizable. <a href="http://www.lawebdelprogramador.com"  target="_top">La Web del programador</a>
	   </div>
